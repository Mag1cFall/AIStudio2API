...
const zhCN = {
  ...
  'settings.warmWorkerLimit': '预热账户数',
  'settings.warmStartupConcurrency': '预热并发数',
  'settings.perAccountConcurrency': '单账号并发数',
  'settings.temporaryChat': '预热使用临时对话',
  'settings.saved': '配置已保存，重启后生效',
...
const en: Record<TranslationKey, string> = {
  ...
  'settings.warmWorkerLimit': 'Prewarmed accounts',
  'settings.warmStartupConcurrency': 'Prewarm concurrency',
  'settings.perAccountConcurrency': 'Requests per account',
  'settings.temporaryChat': 'Use temporary chat for prewarming',
